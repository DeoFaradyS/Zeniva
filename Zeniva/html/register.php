...
<body>
    <section class="register">
        <a href="../php/index.php" id="logo">Zeniva.</a>
        <div class="img">
        ...
        <div class="container">
            ...
            <form action="../php/register-controller.php" method="post" id="form">
